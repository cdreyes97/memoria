...
\begin{itemize}
    \item Debe contener solo caracteres válidos, es decir, la formula debe contener (figura \ref{invalid-formula}): 
    ...
    \item La fórmula debe tener al menos una variable o referencia a una fórmula (figura \ref{invalid-formula}).
...
\begin{figure}[H]
	...
	\caption{\label{fig:invalid-formula} Fórmula inválida: Sin referencias a variables o fórmulas. Elaboración propia.}
\end{figure}
\begin{figure}[H]
	\centering
