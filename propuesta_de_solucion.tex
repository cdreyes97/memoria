...
\begin{enumerate}
    ...
    \item Enviar un ticket al área de soporte con un archivo con formato .kmz o .kml que contiene los polígonos y/o marcadores para sus respectivos sectores y/o nodos.
\end{enumerate}
...
configure el mapa, subiendo su archivo .kmz o .kml y asignando los polígonos/marcadores a sus respectivos sectores/nodos.
...
\begin{itemize}
    \item \textbf{Botones:}
          \begin{itemize}
              ...
              \item En el lado opuesto, se encuentra el botón de 'Cargar Archivo' que, como indica el nombre, es para poder subir el archivo .kmz o .kml que contiene los polígonos y marcadores para asignar.
          \end{itemize}
    \item \textbf{Tabla:}  
    \begin{itemize}
