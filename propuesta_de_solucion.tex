...
\begin{enumerate}
    \item Obtenemos el \textit{JSON} del mapa del campo (\ref{fig:ejemplo-mapa-json}).
    ...
    \begin{lstlisting}[language=XML, frame=single]
        {
            ...
            "bounds": {
                "northEast": {
                    "lat": -29.90524234338656,
                    "lng": -71.24490155790566
                },
                "southWest": {
                    "lat": -85.79336698341737,
                    "lng": 18.729730784756175
                }
            },
            "position": {
                "lat": -59.95262131012406,
                "lng": -71.26186932870023
            },
            "nodos": {
                "[nodoId]": {
                    "lat": -90,
                    "lng": -71.27026921524383
                },
            },
            "sectores": {
                "[sectorId]": {
                    "path": [
                        {
                            "lat": -29.91689674272094,
                            "lng": -71.26038235351966
                        },
                        {
                            "lat": -29.91735543438763,
                            "lng": -71.25778410494456
                        },
                        {
                            "lat": -29.915107113054372,
                            "lng": -71.2573237726045
                        },
                        {
                            "lat": -29.915288548605176,
                            "lng": -71.25993685139193
                        }
                    ],
                    "bounds": {
                        "northEast": {
...
Para finalizar, al hacer click en el botón 'Guardar', se abrirá un diálogo de confirmación para confirmar, valga la redundancia, los cambios hechos y guardarlos.\fi
\iffalse
