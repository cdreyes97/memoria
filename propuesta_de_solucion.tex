...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{water-conexion-form}
...
Esta libreria permite la creación de diagramas meidante objetos \textit{JSON}, esto nos ayuda a poder crear y cargar diagramas de una forma más sencilla. Además, esta librería soporta atributos \textit{custom}, lo que nos permite poder guardar los datos de los formularios en los \texit{json} de los elementos.
